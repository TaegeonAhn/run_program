...
#### 원외처방
for work_path4 in workspace_list4:
    pre4 = pd.read_csv(work_path4,sep="|", dtype='unicode')
...
merged_prescript.to_csv('{}mm33.csv' .format(output_folder_directory), index=False, encoding='utf-8-sig')
